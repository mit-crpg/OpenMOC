...
def compute_sph_factors(mgxs_lib, max_sph_iters=30, sph_tol=1E-5,
    ...
    for i in range(max_sph_iters):
        ...
        sph_mgxs_lib = _apply_sph_factors(mgxs_lib, sph, sph_domains)
