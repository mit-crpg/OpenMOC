...
/*-----------------------------------------------
              @(target):= _openmoc_mic.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__openmoc_mic

#else
#  define SWIG_init    init_openmoc_mic

#endif
#define SWIG_name    "_openmoc_mic"
...
SWIGINTERN PyObject *_wrap_new_MICSolver(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"|OO:new_MICSolver",kwnames,&obj0,&obj1)) SWIG_fail;
  if (obj0) {
  ...
  {
    try {
      result = (MICSolver *)new MICSolver(arg1,arg2);
    } catch (const std::runtime_error &e) {
      SWIG_exception(SWIG_RuntimeError, err_occurred());
      return NULL;
    } catch (const std::exception &e) {
...
SWIGINTERN PyObject *_wrap_MICSolver_computeScalarTrackIndex(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  PyObject *resultobj = 0;
  MICSolver *arg1 = (MICSolver *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OOO:MICSolver_computeScalarTrackIndex",kwnames,&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_MICSolver, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MICSolver_computeScalarTrackIndex" "', argument " "1"" of type '" "MICSolver *""'"); 
  }
  arg1 = reinterpret_cast< MICSolver * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MICSolver_computeScalarTrackIndex" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MICSolver_computeScalarTrackIndex" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  {
    try {
...
SWIGINTERN PyObject *_wrap_machineContainsMIC(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  bool result;
  
  if (!PyArg_ParseTuple(args,(char *)":machineContainsMIC")) SWIG_fail;
  {
    try {
      result = (bool)machineContainsMIC();
    } catch (const std::runtime_error &e) {
      SWIG_exception(SWIG_RuntimeError, err_occurred());
      return NULL;
    } catch (const std::exception &e) {
...
SWIGINTERN PyObject *_wrap_machineContainsHowManyMICs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":machineContainsHowManyMICs")) SWIG_fail;
  {
    try {
      result = (int)machineContainsHowManyMICs();
    } catch (const std::runtime_error &e) {
      SWIG_exception(SWIG_RuntimeError, err_occurred());
      return NULL;
    } catch (const std::exception &e) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"MICSolver_computeScalarTrackIndex", (PyCFunction) _wrap_MICSolver_computeScalarTrackIndex, METH_VARARGS | METH_KEYWORDS, NULL},
...
static void *_p_MICSolverTo_p_Solver(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Solver *)  ((MICSolver *) x));
}
...
static swig_cast_info _swigc__p_Solver[] = {  {&_swigt__p_Solver, 0, 0, 0},  {&_swigt__p_MICSolver, _p_MICSolverTo_p_Solver, 0, 0},{0, 0, 0, 0}};
