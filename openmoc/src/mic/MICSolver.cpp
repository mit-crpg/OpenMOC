 ...
 */
MICSolver::MICSolver(Geometry* geometry, TrackGenerator* track_generator, 
	       int num_threads) {
 ...
 */
Geometry* MICSolver::getGeometry() {
    if (_geometry == NULL)
 ...
 * @return a pointer to the geometry
 */
TrackGenerator* MICSolver::getTrackGenerator() {
 ...
 */
int MICSolver::getNumPolarAngles() {
    return _num_polar;
}
 ...
 */
quadratureType MICSolver::getPolarQuadratureType() {
 ...
 */
int MICSolver::getNumIterations() {
 ...
 */
FP_PRECISION MICSolver::getSourceConvergenceThreshold() {
 ...
 */
FP_PRECISION MICSolver::getFluxConvergenceThreshold() {
 ...
 */
void MICSolver::setPolarQuadratureType(quadratureType quadrature_type) {
 ...
 */
void MICSolver::setNumPolarAngles(int num_polar) {
 ...
 */
void MICSolver::setSourceConvergenceThreshold(FP_PRECISION source_thresh) {
 ...
 */
void MICSolver::setFluxConvergenceThreshold(FP_PRECISION flux_thresh) {
    if (flux_thresh <= 0.0)
 ...
 */
void MICSolver::checkTrackSpacing() {
