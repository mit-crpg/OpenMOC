...
MaterializeH5Suite = unittest.TestLoader().loadTestsFromTestCase(TestH5Files)
MaterializeH5Suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestUO2))
MaterializeH5Suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestFissionChamber))
MaterializeH5Suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestWater))

unittest.TextTestRunner(verbosity=2).run(MaterializeH5Suite)
