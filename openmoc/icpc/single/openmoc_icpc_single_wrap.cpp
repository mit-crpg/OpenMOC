...
/*-----------------------------------------------
              @(target):= _openmoc_icpc_single.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__openmoc_icpc_single

#else
#  define SWIG_init    init_openmoc_icpc_single

#endif
#define SWIG_name    "_openmoc_icpc_single"
