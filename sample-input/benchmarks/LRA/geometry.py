...
assembly1_lattice.setUniverses3D([template])
...
assembly2_lattice.setUniverses3D([template])
...
assembly3_lattice.setUniverses3D([template])
...
assembly4_lattice.setUniverses3D([template])
...
assembly5_lattice.setUniverses3D([template])
...
assembly6_lattice.setUniverses3D([template])
...
core_lattice.setUniverses3D([template])
