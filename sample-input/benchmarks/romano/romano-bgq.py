...
fuel.setSigmaA([0.069389522])
fuel.setSigmaT([0.452648699])
fuel.setSigmaF([0.0414198575])
fuel.setNuSigmaF([0.0994076580])
fuel.setSigmaS([0.38259177])
fuel.setChi([1.0])

moderator.setSigmaA([0.003751099]) 
moderator.setSigmaT([0.841545641])
moderator.setSigmaF([0.0])
moderator.setNuSigmaF([0.0])
moderator.setSigmaS([0.837794542])
moderator.setChi([1.0])
