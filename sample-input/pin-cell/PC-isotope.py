...
# Importing microscopic cross sections from HDF5 to populate Isotopes
mgxs = h5.File('isotopes.h5')

# O-16 in Fuel
o16f = Isotope(name='O-16 in Fuel')
o16f.setNumEnergyGroups(8)
xs = mgxs['Fuel']['O-16']
o16f.setSigmaT(np.array(xs['transport'][:]))
o16f.setSigmaA(np.array(xs['absorption'][:]))
o16f.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))

# U-235
u235 = Isotope(name='U-235')
u235.setNumEnergyGroups(8)
xs = mgxs['Fuel']['U-235']
u235.setSigmaT(np.array(xs['transport'][:]))
u235.setSigmaA(np.array(xs['absorption'][:]))
u235.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
u235.setSigmaF(np.array(xs['fission'][:]))
u235.setNuSigmaF(np.array(xs['nu-fission'][:]))
u235.setChi(np.array(xs['chi'][:]))

# U-238
u238 = Isotope(name='U-238')
u238.setNumEnergyGroups(8)
xs = mgxs['Fuel']['U-238']
u238.setSigmaT(np.array(xs['transport'][:]))
u238.setSigmaA(np.array(xs['absorption'][:]))
u238.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
u238.setSigmaF(np.array(xs['fission'][:]))
u238.setNuSigmaF(np.array(xs['nu-fission'][:]))
u238.setChi(np.array(xs['chi'][:]))

# H-1
h1 = Isotope(name='H-1')
h1.setNumEnergyGroups(8)
xs = mgxs['Water']['H-1']
h1.setSigmaT(np.array(xs['transport'][:]))
h1.setSigmaA(np.array(xs['absorption'][:]))
h1.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Water']['O-16']
o16m.setSigmaT(np.array(xs['transport'][:]))
o16m.setSigmaA(np.array(xs['absorption'][:]))
o16m.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Water']['B-10']
b10.setSigmaT(np.array(xs['transport'][:]))
b10.setSigmaA(np.array(xs['absorption'][:]))
b10.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))

# B-11
b11 = Isotope(name='B-11')
b11.setNumEnergyGroups(8)
xs = mgxs['Water']['B-11']
b11.setSigmaT(np.array(xs['transport'][:]))
b11.setSigmaA(np.array(xs['absorption'][:]))
b11.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Clad']['Zr-90']
zr90.setSigmaT(np.array(xs['transport'][:]))
zr90.setSigmaA(np.array(xs['absorption'][:]))
zr90.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Clad']['Zr-91']
zr91.setSigmaT(np.array(xs['transport'][:]))
zr91.setSigmaA(np.array(xs['absorption'][:]))
zr91.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Clad']['Zr-92']
zr92.setSigmaT(np.array(xs['transport'][:]))
zr92.setSigmaA(np.array(xs['absorption'][:]))
zr92.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Clad']['Zr-94']
zr94.setSigmaT(np.array(xs['transport'][:]))
zr94.setSigmaA(np.array(xs['absorption'][:]))
zr94.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
xs = mgxs['Clad']['Zr-96']
zr96.setSigmaT(np.array(xs['transport'][:]))
zr96.setSigmaA(np.array(xs['absorption'][:]))
zr96.setSigmaS(np.array(xs['scatter matrix'][:]).flatten('F'))
...
# Note: number densities in a/b-cm
