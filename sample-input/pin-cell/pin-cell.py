...
circle = Circle(id=1, x=0.0, y=0.0, radius=1.0)
left = XPlane(id=2, x=-2.0)
right = XPlane(id=3, x=2.0)
top = YPlane(id=4, y=2.0)
bottom = YPlane(id=5, y=-2.0)
...
track_generator.setNumAzim(512)
