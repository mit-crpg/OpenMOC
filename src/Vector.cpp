...
Vector::Vector(omp_lock_t* cell_locks, int num_x, int num_y, int num_z,
  ...
  _array = new NEW_FP_PRECISION[_num_rows];
  setAll(0.0);
 ...
 */
void Vector::incrementValue(int cell, int group, NEW_FP_PRECISION val) {
...
void Vector::setAll(NEW_FP_PRECISION val) {
 ...
 */
void Vector::setValue(int cell, int group, NEW_FP_PRECISION val) {
 ...
 */
void Vector::scaleByValue(NEW_FP_PRECISION val) {
 ...
 */
NEW_FP_PRECISION Vector::getValue(int cell, int group) {
 ...
 */
NEW_FP_PRECISION* Vector::getArray() {
  return _array;
}
