...
inline void expG2_fractional(FP_PRECISION x, FP_PRECISION* expG2) {
  ...
  /* Coefficients for numerator */
  const FP_PRECISION a1 = -8.335775885589858E-2;
  const FP_PRECISION a2 = -3.603942303847604E-3;
  const FP_PRECISION a3 = 3.7673183263550827E-3;
  const FP_PRECISION a4 = 1.124183494990467E-5;
  const FP_PRECISION a5 = 1.6837426505799449E-4;

  /* Coefficients for denominator */
  const FP_PRECISION b1 = 7.454048371823628E-1;
  const FP_PRECISION b2 = 2.3794300531408347E-1;
  const FP_PRECISION b3= 5.367250964303789E-2;
  const FP_PRECISION b4 = 6.125197988351906E-3;
  const FP_PRECISION b5 = 1.0102514456857377E-3;
