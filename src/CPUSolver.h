...
/* Structure containing the info to send about a track */
struct sendInfo {
  long track_id;
  int domain;
  bool fwd;
...
protected:
...
#ifdef MPIx
  /* Size of message when communicating track angular fluxes at interfaces */
  ...
  /* Domains neighboring local domain */
