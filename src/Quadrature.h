...
protected:
  ...
  void setPolarValues(T** array, int azim_index, int polar_index, T value) {
    ...
    array[_num_azim/2 + azim_index]    [polar_index] = value;
    array[_num_azim - azim_index - 1]  [polar_index] = value;

    array[azim_index]                  [_num_polar - polar_index - 1] = value;
    array[_num_azim/2 - azim_index - 1][_num_polar - polar_index - 1] = value;
    array[_num_azim/2 + azim_index]    [_num_polar - polar_index - 1] = value;
    array[_num_azim - azim_index - 1]  [_num_polar - polar_index - 1] = value;
  }
  ...
  void setAzimuthalValues(T* array, int azim_index, T value) {
    ...
    array[_num_azim/2 + azim_index] = value;
    array[_num_azim - azim_index - 1] = value;
  }
...
public:
  ...
  FP_PRECISION getSinThetaInline(int azim, int polar);
 ...
 * @return the total weight of each Track with the given indexes
 */
inline FP_PRECISION Quadrature::getSinThetaInline(int azim, int polar) {
