...
class PwrAssemblyTestHarness(TestHarness):
    ...
    def _create_geometry(self):
        ...
        self.input_set.geometry.setDomainDecomposition(2, 2, 3, MPI.COMM_WORLD)
    ...
    def _run_openmoc(self):
        """Run a few sweeps then use the boundary flux checker."""
        self.solver.computeEigenvalue(max_iters=4)
        self.solver.boundaryFluxChecker()

        # To check individual tracks
        self.solver.printCycle(1, 0, 10)
