...
class PlotMaterialsTestHarness(TestHarness):
    """Test materials plotting with a 4x4 lattice."""
    ...
    def _run_openmoc(self):
        ...
        self.figures.append(
            plot_materials(geometry, gridsize=100, get_figure=True))
        self.figures.append(
            plot_materials(geometry, gridsize=100, zcoord=10., get_figure=True))
        self.figures.append(
            plot_materials(geometry, gridsize=100, get_figure=True, 
                       xlim=(0., 2.), ylim=(0., 2.)))
        self.figures.append(
    ...
    def _get_results(self, num_iters=True, keff=True, fluxes=True,
        ...
        for i, fig in enumerate(self.figures):
            plot_filename = 'materials-{0}.png'.format(i)
    ...
    def _cleanup(self):
        ...
        super(PlotMaterialsTestHarness, self)._cleanup()
