...
# Parameters to use this file to generate libraries for all the SPH tests
# test_sph_cell uses per-cell isotropic cross sections
# test_sph_material uses per-material P0 transport corrected cross sections
# test_sph_eigenvalue uses the per-material cross sections
domain_type = 'cell'
...
if scattering == 'isotropic':
    ...
    mgxs_lib.mgxs_types = ['nu-transport', 'nu-fission', 'consistent nu-scatter matrix', 'chi']
