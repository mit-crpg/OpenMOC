...
class test_default_init(unittest.TestCase):
...
class test_custom_init(unittest.TestCase):
...
test_options_suite = unittest.TestLoader().loadTestsFromTestCase(test_default_init)
test_options_suite.addTests(unittest.TestLoader().loadTestsFromTestCase(test_custom_init))

if __name__ == '__main__':

    unittest.TextTestRunner(verbosity=2).run(test_options_suite)
