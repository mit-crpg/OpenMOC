...
U235_density_assembly = .0029946 / F;
U238_density_assembly = .0269514 / F;
NA23_density_assembly = .009234 * (1 / F) * (F^2 - 0.62) / 0.38;
NA23_density_blanket  = .0243 * F;
...
xs_abs_assembly = (U235_density_assembly * U235a + U238_density_assembly * U238a...
    + NA23_density_assembly * NA23a)' + xs_fis_assembly;
